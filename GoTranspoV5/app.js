...
app.get("/socialPosts",function(req,res)
{
	User.find({}, function(err, foundUsers)
	{
		...
		else
		{
			...
			{
				foundUsers[i].populate("Post").execPopulate(function(err, completeUser){
					console.log("=====================")
			...
			// foundUsers.forEach(function(data)
			// {
			// 	console.log("=====================")
			// 	console.log(data);
			// 	console.log("=====================")
			// })
			// res.render("socialPosts", {users: foundUsers});
			...
			// 	// data.populate("Post").exec(function(err, completeUser){
			// 	// 	if(err)
			// 	// 	{
			// 	// 		console.log(err);
			// 	// 	}
